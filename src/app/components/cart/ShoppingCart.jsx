          ...
          >
            ...
            {cart.length > 0 && (
              <div className="border-t p-4 space-y-4">
                ...
                {hasCotizableItems && (
                  <div className="text-xs text-[#8f5f49] font-medium">
                ...
                <div className="space-y-2">
                  ...
                  {hasCotizableItems && (
                    <a
                      ...
                      onClick={closeCart}
                      className="flex items-center justify-center gap-2 w-full py-2 px-4 bg-[#8f5f49] text-white text-center text-sm font-medium rounded hover:bg-[#7a5040] transition-colors"
                    >
