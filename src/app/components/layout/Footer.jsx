        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">info@Manos del Marga Marga.cl</p>
            </div>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Síguenos</h4>
            <div className="flex space-x-4">
              <Link href="https://instagram.com/Manos del Marga Marga" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
              ...
              <Link href="https://facebook.com/Manos del Marga Marga" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white flex items-center">
                <svg className="w-5 h-5 mr-1" fill="currentColor" viewBox="0 0 24 24">
